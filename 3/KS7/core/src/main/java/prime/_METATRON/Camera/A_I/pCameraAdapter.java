package prime._METATRON.Camera.A_I;
...
import prime._METATRON.iMonad;
import prime._METATRON.iSpace;
import prime._METATRON.Camera.pCamera;
...
public abstract class pCameraAdapter extends aCameraController implements iMonad {
	...
	public void update() {
		if (this.exists && isOn) {
			...
			this.transform.setRotation(VectorUtils.upcast(this.getCameraDirection(), 0));
			this.transform.setPosition(this.getCameraPosition());
		}
