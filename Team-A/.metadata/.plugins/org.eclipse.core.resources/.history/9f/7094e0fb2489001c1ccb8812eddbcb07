...
public class SQLStringScriptor {
    ...
    public static String getFieldNameList(aList<Column> columns) {
    ...
    public static String getSetClause(aList<Column> columns) {
        //Create return string
        String setClause = "";
    ...
    public static String makeCreateSQLString(Repository repository) {
        ...
        aList<Column> columns = repository.getTable().getWriteableFields();
        ...
        String placeholderList = getPlaceholderList(columns.getSize());
    ...
    public static String makeReadSQLString(Repository repository) {
        ...
        aList<Column> columns = repository.getTable().getReadableFields();
