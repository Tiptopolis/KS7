	...
	public static final String HEX =  "0123456789ABCDEF";
	 ...
	 public static final String PERMISSIBLE_CHARS =
	    ...
	    public static final String LATIN_EXTENDED_LETTERS_UPPER =
	            "À�?ÂÃÄÅÆÇÈÉÊËÌ�?Î�?�?ÑÒÓÔÕÖØÙÚÛÜ�?ÞĀĂĄĆĈĊČĎ�?ĒĔĖĘĚĜĞĠĢĤĦĨĪĬĮİĴĶĹĻĽĿ�?ŃŅŇŊŌŎ�?ŒŔŖŘŚŜŞŠŢŤŨŪŬŮŰŲŴŶŸŹŻŽǺǼǾȘȚẀẂẄỲßSFJ";
	    public static final String LATIN_EXTENDED_LETTERS_LOWER =
	            "àáâãäåæçèéêëìíîïðñòóôõöøùúûüýþ�?ăąćĉċ�?�?đēĕėęě�?ğġģĥħĩīĭįıĵķĺļľŀłńņňŋ�?�?őœŕŗřś�?şšţťũūŭůűųŵŷÿźżžǻǽǿșț�?ẃẅỳßſƒȷ";
	    ...
	    public static final String GREEK_LETTERS_UPPER =
	            "ΑΒΓΔΕΖΗΘΙΚΛΜ�?ΞΟΠΡΣΣΤΥΦΧΨΩΆΈΉΊΌΎ�?ΪΫΪΫ";
	    
	    public static final String GREEK_LETTERS_LOWER =
	            "αβγδεζηθικλμνξοπ�?ςστυφχψωάέήίό�?ώϊϋ�?ΰ";
	    ...
	    public static final String CYRILLIC_LETTERS_UPPER =
	            "�?БВГДЕЖЗИЙКЛМ�?ОПРСТУФХЦЧШЩЪЫЬЭЮЯЀ�?ЂЃЄЅІЇЈЉЊЋЌ�?Ў�?Ѵ�?";
	    public static final String CYRILLIC_LETTERS_LOWER =
	            "абвгдежзийклмнопр�?туфхцчшщъыь�?ю�?�?ёђѓєѕіїјљњћќ�?ўџѵґ";
