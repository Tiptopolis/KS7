...
public abstract class Glyph {
	...
	public Quaternion data = new Quaternion(0, 0, 0, 0); // w,h,z-index,state
	...
	public Glyph(GlyphSheet from, char using) {
		...
		this.data = new Quaternion(Tex.T.getRegionWidth(), Tex.T.getRegionHeight(), 1, 1);
	}
	
	public Glyph(char using)
	{
		this(FontAtlas.DefaultGlyphs,using);
	}
	
	public Glyph(BitmapFont font, char using)
	{
		//FontAtlas.FontCache.put(font, font.sc)
	}
