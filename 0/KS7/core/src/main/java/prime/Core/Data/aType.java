...
public class aType extends aNode<aType> implements iType {
	...
	public Object of(String is) {
		if (this.of.getSimpleName().equals(is) || this.of.getSimpleName().toUpperCase().equals(is.toUpperCase()))
			return this.of;
		else
			return null;
	}
	...
	public Object of(Object is) {
		if (is instanceof Class)
			return this.of(((Class) is).getSimpleName());
		else if (is instanceof aType)
			return this.of(((aType) is).of);
		else
			return this.of(is.getClass().getSimpleName());
