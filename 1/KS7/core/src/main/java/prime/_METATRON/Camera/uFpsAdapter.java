...
public class uFpsAdapter extends pCameraAdapter {
	...
	public void transformUpdated() {
		...
		this.transform.setScale(this.getCameraSize());
		this.transform.setLocalRotation(VectorUtils.upcast(this.perspective.getDirection(),0));
		this.transform.setPosition(this.perspective.getOfficialPosition());
		// Log(" -->>>>>>>");
	}
